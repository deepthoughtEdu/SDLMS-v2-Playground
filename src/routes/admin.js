...
module.exports = function (app, middleware, controllers) {
	...
	helpers.setupAdminPageRoute(app, '/admin/manage/anecdotes', middleware, middlewares, controllers.admin.anecdotes.get);
	helpers.setupAdminPageRoute(app, '/admin/manage/rigorRank', middleware, middlewares, controllers.admin.rigorRank.get);

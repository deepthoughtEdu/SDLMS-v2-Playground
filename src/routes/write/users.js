...
function authenticatedRoutes() {
	...
	setupApiRoute(router, 'put', '/:uid/role/:role', [...middlewares, middleware.assert.user], controllers.write.users.assignRoles);
	...
	setupApiRoute(router, 'get', '/:uid', [...middlewares], controllers.write.users.getUser);
}

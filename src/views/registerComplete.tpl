...
<form role="form" method="post" action="{config.relative_path}/register/complete/?_csrf={config.csrf_token}" enctype="multipart/form-data">
	...
	<div class="row justify-content-center my-2">
		<div class="col-xs-12 col-sm-8 col-sm-offset-2">
			<button class="btn btn-primary btn-block button-primary">[[topic:composer.submit]]</button>
		</div>
	</div>
</form>

	<form role="form" method="post" class="justify-content-center row" action="{config.relative_path}/register/abort">
		<p class="text-center ps-0 col-xs-12 col-sm-8 col-sm-offset-2">

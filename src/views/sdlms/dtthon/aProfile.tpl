        ...
        <form>
          <div class="d-flex pl-3">
            <div class="form-group">
              ...
              <div>
                <textarea class="text-box" id="description" name="name" rows="5" cols="160" placeholder="I have given pre-requisites for this project..." style="outline: none; font-size: var(--sdlms-font-size-14);"></textarea>
              </div>
            </div>
          </div>
          <div class="d-flex pt-3 pl-3">
            <div class="pr-3 bold-font">
              I am ready to take responsiblity
            </div>
            <div>
              <select class="select-box" style="outline:none;">

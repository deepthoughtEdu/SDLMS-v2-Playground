<div class="sdlms-container px-0">
    <div class="sdlms-section session-view sdlms-form-elements">
      ...
      <div class="col-md-4 p-md-2" collapse>
        <div class="dtThone-journey-board sdlms-section position-fixed" style="z-index:5; left:0; top: 17%; height: calc(100% - 65px); border-top-left-radius: 0" collapse-right>
      ...
      <div class="col-md-11" style="margin-left:40px;">
        <div class="col-12 p-0 pt-4">
          <div class="row" id="storyboard-asset">
            <div class="dtthon-input-asset col-md-8">
            </div>
          </div>
        </div>
      </div>

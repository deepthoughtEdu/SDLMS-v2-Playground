    <div class="sdlms-section session-view sdlms-form-elements">
      <div class="sdlms-section-header shadow-none custom-padding-x-40 primary-header align-items-center justify-content-between ">
        <div class="d-flex align-items-center sdlms-text-white-20px ">Create Story for your project</div>
      </div>
      <div class="col-md-4 p-md-2" collapse>
        <div class="dtThone-journey-board sdlms-section position-fixed" style="z-index:5; left:0; top: 125px; height: calc(100% - 65px); border-top-left-radius: 0" collapse-right>
      ...
      <h1 class="sdlms-text-black-22px task-heading mt-4" style="text-align:center;"> Task Name </h1>
      <div class="col-md-11" style="margin-left:40px;">
        <div class="col-12 p-0 pt-4">
          <div class=" d-flex align-items-center justify-content-left" create-assets>
            <button type="button" class="sdlms-button button-primary button-md d-flex align-items-center " id="create-asset">Add Asset</button>
          </div>
    ...
    <div class="pl-0 mt-4 d-flex align-items-center justify-content-end">
      <button type="submit" id="create-profile" class="sdlms-button button-primary button-lg d-flex align-items-center">Publish</button>
    </div>
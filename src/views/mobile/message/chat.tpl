...
<div id="chats" class="align-items-center col-12 d-flex flex-column justify-content-center pb-5 pt-5 px-3">

    <div class="d-flex justify-content-center mt-2 font-10">
        <p class="mb-0">Today</p>
    </div>

    <div id="chats-recieved"
        class="d-flex flex-column justify-content-center align-items-center chat-row incoming">

        <div class="chat mb-1 font-14">
            <p class="mb-0">Hi Olivia, Please accept my message request, so that I can bug you with things that
                you have no
                interest for. Isn't that fun?</p>
        </div>
        <div class="chat mb-1 font-14">
            <p class="mb-0">Hi Olivia, Please accept my message request, so that I can bug you with things that
                you have no
    ...
    <div id="chats-sent" class="d-flex flex-column justify-content-center align-items-center chat-row outgoing">
        <div class="chat mb-1  font-14">
            <p class="mb-0">Hi Olivia, Please accept my message request, so that I can bug you with things that
                you have no
                interest for. Isn't that fun?</p>
...
<form action="" id="message-input">
    ...
    <div class="d-none attachments-menu">
        <div
            ...
            <input type="file" accept="image/*" class="form-control-file d-none" id="img-attach" name="files[img]" />
            ...
            <input type="file" accept="image/*" class="form-control-file d-none" id="cam-attach" name="files[cam]" />

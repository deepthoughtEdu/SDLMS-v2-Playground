...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-chats" role="tabpanel" aria-labelledby="nav-chats-tab">
        ...
        <div class="messages d-flex flex-column pt-3">
                ...
                <div class="d-flex justify-content-between w-75">
                    <div class="message-content d-flex flex-column ">
                        ...
                        <div class="message-details">
                            <p class="font-10 font-regular mb-0">Socratic Dialogue is the collective deliberation of
                                very
                    ...
                    <div class="message-extra-details d-flex flex-column mx-2  align-items-center">
                        <div class="message-time">
                            <p class="font-10 font-regular text-center">9:30 AM</p>
                        </div>
                        <div class="messages__read d-none">

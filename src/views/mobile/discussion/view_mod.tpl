<div class="d-none secondary-bg py-3 px-2 shadow-sm rounded-10-px floating-right" id="participant-options">
...
<div class="d-none secondary-bg py-3 px-2 shadow-sm rounded-10-px floating-right" id="participant-options-selected">

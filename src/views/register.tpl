...
<div class="row register justify-content-center">
	<div class="col-sm-12 col-md-8">
		<div class="register-block">
			<div class="alert alert-danger<!-- IF !error --> hidden d-none <!-- ENDIF !error -->" id="register-error-notify" >
			...
			<form component="register/local" class="form-horizontal" role="form" action="{config.relative_path}/register" method="post">
				...
				<div class="form-group my-2">
					...
					<div id="register-{regFormEntry.styleName}" class="col-12">
						{{regFormEntry.html}}
					</div>
				</div>
				{{{end}}}
				...
				<div class="form-group py-2">
					<div class="col-lg-offset-4 col-lg-8">
						<button class="btn btn-primary btn-lg btn-block button-primary" id="register" type="submit">[[register:register_now_button]]</button>
					</div>
				</div>

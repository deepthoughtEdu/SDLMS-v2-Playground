...
App.deleteAllRooms = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.deleteAllRooms(req))
}
...
App.addMods = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.manageModerators(req, 'add'))
}
App.removeMods = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.manageModerators(req, 'remove'))
}
App.updateRules = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.updateRules(req))
}
App.highlightThread = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.highlightThread(req, { isHighlited: true }))
}
App.reportThread = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.reportThread(req, true))
}
App.saveThread = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.saveThread(req))
}
App.getHighlightedThreads = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getHighlightedThreads(req))
}
App.getReportedThreads = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getReportedThreads(req))
}
App.getSavedThreads = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.getSavedThreads(req))
}
App.removeHighlightedThread = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.highlightThread(req, { isHighlited: false }))
}
App.removeReportedThread = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.reportThread(req, false))
}
App.removeSavedThread = async (req, res) => {
	helpers.formatApiResponse(200, res, await api.appApi.removeSavedThread(req))
}
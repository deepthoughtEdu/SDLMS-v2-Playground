...
middleware.renderHeader = async function renderHeader(req, res, data) {
	console.log('renderHeader', data.context);
	...
	let headerPath = data.context && data.context == 'widget' ? 'widgets/header' : 'partials/header';
	return await req.app.renderAsync(headerPath, hookReturn.templateValues);
};
...
middleware.renderFooter = async function renderFooter(req, res, templateValues) {
	console.log('renderFooter', templateValues.context);
	...
	let footerPath = templateValues.context && templateValues.context == 'widget' ? 'widgets/footer' : 'partials/footer';
	return await req.app.renderAsync(footerPath, data.templateValues);
};

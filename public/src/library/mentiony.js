...
(function ($) {
    ...
    var MentionsInput = function (settings) {
        ...
        function onInputBoxInput(e) {
            ...
            var converted = e.originalEvent.data ? e.originalEvent.data.charCodeAt(0) : 0;
        ...
        function showDropDown() {
            ...
            popoverEle.css({
                display: 'block',
                top:     curAbsPos.y - (elmInputBoxContentAbsPosition.top - $(document).scrollTop()) + ((editableContentLineHeightPx || 30) + 10),

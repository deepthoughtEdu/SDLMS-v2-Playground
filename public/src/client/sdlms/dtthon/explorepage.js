...
define("forum/sdlms/dtthon/DtExplorePage", ["api"], function (api) {
	var DtExplorePage = {};
	DtExplorePage.init = function () {
		...
		$("[ApplyFilter]").on("click", function () {
            ...
            DtthonArray
			$(".Dtthon-filter-body").slideToggle("slow");
            DtExplorePage.paginateExplorePage(`/apps/project?title=${name}`, {
		...
		DtExplorePage.paginateExplorePage(`/apps/project`, {
			parent: "dtthon-explore-page",
		});
	...
	$(".sdlms-container")
		...
		.on("click", function () {
			...
			if (url) {
				DtExplorePage.paginateExplorePage(url, {
					parent: "dtthon-explore-page",
				});
				return;
			}
	...
	DtExplorePage.paginateExplorePage = (
		url,
		data = {}
	) => {
